...
def depthFirstSearch(problem):
    ...
    while not stack.isEmpty():
        position,actions,visited = stack.pop()
        if problem.isGoalState(position):
            ...
            for successor, action, stepCost in successors:
                if successor not in visited:
                    ...
                    newVisited.append(successor)
                    newActions = list(actions)
                    newActions.append(action)
                    stack.push((successor,newActions,newVisited))
    return []
...
def uniformCostSearch(problem):
    ...
    visited[problem.getStartState()] = -99999999999999
    while not queue.isEmpty():
        position,actions = queue.pop()
        if problem.isGoalState(position):
            return actions
            ...
            for successor, action, stepCost in successors:
                ...
                if successor not in visited or visited[successor] > newCost:
                    ...
                    queue.push((successor,newActions), newCost)
    return []
